...
/*
    #ifdef __MORPHOS__
    strcpy(code_to_convert,pendisplay_specs[1]->buf);
    if(strlen(code_to_convert)==7)
    {
        strcpy(background2,"2:");
        background2[2]=code_to_convert[1];
        background2[3]=code_to_convert[2];
        background2[4]=code_to_convert[1];
        background2[5]=code_to_convert[2];
        background2[6]=code_to_convert[1];
        background2[7]=code_to_convert[2];
        background2[8]=code_to_convert[1];
        background2[9]=code_to_convert[2];
        background2[10]=',';
        background2[11]=code_to_convert[3];
        background2[12]=code_to_convert[4];
        background2[13]=code_to_convert[3];
        background2[14]=code_to_convert[4];
        background2[15]=code_to_convert[3];
        background2[16]=code_to_convert[4];
        background2[17]=code_to_convert[3];
        background2[18]=code_to_convert[4];
        background2[19]=',';
        background2[20]=code_to_convert[5];
        background2[21]=code_to_convert[6];
        background2[22]=code_to_convert[5];
        background2[23]=code_to_convert[6];
        background2[24]=code_to_convert[5];
        background2[25]=code_to_convert[6];
        background2[26]=code_to_convert[5];
        background2[27]=code_to_convert[6];
        background2[28]='\0';

        //printf("old background:%s\n",code_to_convert);
        //printf("new background:%s\n",background2);

    }
    #else
    {
        //channel background
        memset(background2,'\0',63); strcpy(background2," "); strcat(background2,pendisplay_specs[1]->buf);
    ...
    if(status_current)
    {
        ...
        {
            if(status_current->current_query->LV_channel != NULL)
            setmacro((Object*)status_current->current_query->LV_channel,MUIA_NList_ListBackground, background2);
        }
    }
    if(WookieChat->LV_graphical_smileys_preview != NULL)
        setmacro((Object*)WookieChat->LV_graphical_smileys_preview ,MUIA_NList_ListBackground, background2);


    //nicklist background
    #ifdef __MORPHOS__
    strcpy(code_to_convert,pendisplay_specs[2]->buf);
    if(strlen(code_to_convert)==7)
    {
        strcpy(background,"2:");
        background[2]=code_to_convert[1];
        background[3]=code_to_convert[2];
        background[4]=code_to_convert[1];
        background[5]=code_to_convert[2];
        background[6]=code_to_convert[1];
        background[7]=code_to_convert[2];
        background[8]=code_to_convert[1];
        background[9]=code_to_convert[2];
        background[10]=',';
        background[11]=code_to_convert[3];
        background[12]=code_to_convert[4];
        background[13]=code_to_convert[3];
        background[14]=code_to_convert[4];
        background[15]=code_to_convert[3];
        background[16]=code_to_convert[4];
        background[17]=code_to_convert[3];
        background[18]=code_to_convert[4];
        background[19]=',';
        background[20]=code_to_convert[5];
        background[21]=code_to_convert[6];
        background[22]=code_to_convert[5];
        background[23]=code_to_convert[6];
        background[24]=code_to_convert[5];
        background[25]=code_to_convert[6];
        background[26]=code_to_convert[5];
        background[27]=code_to_convert[6];
        background[28]='\0';
    ...
    #else
    {
        memset(background,'\0',63); strcpy(background," "); strcat(background,pendisplay_specs[2]->buf);
    ...
    if(status_current)
    {
        if(status_current->current_query)
        {
            ...
            if(status_current->current_query->LV_nicklist != NULL)
            {
                setmacro((Object*)status_current->current_query->LV_nicklist,MUIA_NList_ListBackground, background);
                setmacro((Object*)status_current->current_query->LV_nicklist,MUIA_NList_ListPen, pendisplay_specs[22]);
            }
        }
    }
    //listview style tabs
    #ifdef __MORPHOS__
    strcpy(code_to_convert,pendisplay_specs[23]->buf);
    if(strlen(code_to_convert)==7)
    {
        strcpy(background4,"2:");
        background4[2]=code_to_convert[1];
        background4[3]=code_to_convert[2];
        background4[4]=code_to_convert[1];
        background4[5]=code_to_convert[2];
        background4[6]=code_to_convert[1];
        background4[7]=code_to_convert[2];
        background4[8]=code_to_convert[1];
        background4[9]=code_to_convert[2];
        background4[10]=',';
        background4[11]=code_to_convert[3];
        background4[12]=code_to_convert[4];
        background4[13]=code_to_convert[3];
        background4[14]=code_to_convert[4];
        background4[15]=code_to_convert[3];
        background4[16]=code_to_convert[4];
        background4[17]=code_to_convert[3];
        background4[18]=code_to_convert[4];
        background4[19]=',';
        background4[20]=code_to_convert[5];
        background4[21]=code_to_convert[6];
        background4[22]=code_to_convert[5];
        background4[23]=code_to_convert[6];
        background4[24]=code_to_convert[5];
        background4[25]=code_to_convert[6];
        background4[26]=code_to_convert[5];
        background4[27]=code_to_convert[6];
        background4[28]='\0';
    ...
    #else
    {
        memset(background4,'\0',63); strcpy(background4," "); strcat(background4,pendisplay_specs[23]->buf);
        background4[0]='2'; background4[1]=':';
    }
    #endif

    if(WookieChat->LV_tabs != NULL)
    {
        setmacro((Object*)WookieChat->LV_tabs,MUIA_NList_ListBackground, background4);
        setmacro((Object*)WookieChat->LV_tabs,MUIA_NList_ListPen, pendisplay_specs[24]);
