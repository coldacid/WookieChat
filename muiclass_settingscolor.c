...
static struct ConfigItem TAB_CONFIGITEMS[] = {
	{ GID_CHANNELLISTBACKGROUND, OID_SETTINGSCOLOR + PEN_CHANNELLISTBACKGROUND, MUIA_Pendisplay_Spec, (LONG) "2:1D451D45,2B5D2B5D,8D798D79" },
	{ GID_CHANNELLISTTEXT      , OID_SETTINGSCOLOR + PEN_CHANNELLISTTEXT      , MUIA_Pendisplay_Spec, (LONG) "rFFFFFFFF,8FC08FC0,12D012D0" },
	{ GID_CHANNELLISTUSER      , OID_SETTINGSCOLOR + PEN_CHANNELLISTUSER      , MUIA_Pendisplay_Spec, (LONG) "rFFFDFFFD,FFFCFFFC,FFFFFFFF" },
	{ GID_CHANNELLISTSERVER    , OID_SETTINGSCOLOR + PEN_CHANNELLISTSERVER    , MUIA_Pendisplay_Spec, (LONG) "2:DE50DE50,DE4ADE4A,DE47DE47" },
	{ GID_CHANNELLISTHIGHLIGHT , OID_SETTINGSCOLOR + PEN_CHANNELLISTHIGHLIGHT , MUIA_Pendisplay_Spec, (LONG) "2:00000000,00000000,00000000" },
	{ GID_USERLISTBACKGROUND   , OID_SETTINGSCOLOR + PEN_USERLISTBACKGROUND   , MUIA_Pendisplay_Spec, (LONG) "2:1D451D45,2B5D2B5D,8D798D79" },
	{ GID_USERLISTTEXT         , OID_SETTINGSCOLOR + PEN_USERLISTTEXT         , MUIA_Pendisplay_Spec, (LONG) "rE7D8E7D8,25A425A4,FFFFFFFF" },
	{ GID_LOGLISTBACKGROUND    , OID_SETTINGSCOLOR + PEN_LOGLISTBACKGROUND    , MUIA_Pendisplay_Spec, (LONG) "2:1D451D45,2B5D2B5D,8D798D79" },
	{ GID_LOGPRIVMSG           , OID_SETTINGSCOLOR + PEN_LOGPRIVMSG           , MUIA_Pendisplay_Spec, (LONG) "r209C209C,A1AFA1AF,1A271A27" },
	{ GID_LOGJOIN              , OID_SETTINGSCOLOR + PEN_LOGJOIN              , MUIA_Pendisplay_Spec, (LONG) "rFFFFFFFF,0D620D62,00000000" },
	{ GID_LOGPART              , OID_SETTINGSCOLOR + PEN_LOGPART              , MUIA_Pendisplay_Spec, (LONG) "rFFFF0000,FFFF0000,FFFF0000" },
	{ GID_LOGQUIT              , OID_SETTINGSCOLOR + PEN_LOGQUIT              , MUIA_Pendisplay_Spec, (LONG) "rFFFDFFFD,FFFBFFFB,FFFFFFFF" },
	{ GID_LOGMODE              , OID_SETTINGSCOLOR + PEN_LOGMODE              , MUIA_Pendisplay_Spec, (LONG) "rFFFFFFFF,AEACAEAC,D159D159" },
	{ GID_LOGCTCP              , OID_SETTINGSCOLOR + PEN_LOGCTCP              , MUIA_Pendisplay_Spec, (LONG) "r7C3B7C3B,FFFFFFFF,F8CEF8CE" },
	{ GID_LOGACTION            , OID_SETTINGSCOLOR + PEN_LOGACTION            , MUIA_Pendisplay_Spec, (LONG) "rFFFFFFFF,FBCCFBCC,25A225A2" },
	{ GID_LOGINFO              , OID_SETTINGSCOLOR + PEN_LOGINFO              , MUIA_Pendisplay_Spec, (LONG) "rFFFFFFFF,1A591A59,25292529" },
	{ GID_LOGOWNTEXT           , OID_SETTINGSCOLOR + PEN_LOGOWNTEXT           , MUIA_Pendisplay_Spec, (LONG) "rFFFFFFFF,12D012D0,168E168E" },
	{ GID_LOGHIGHLIGHT         , OID_SETTINGSCOLOR + PEN_LOGHIGHLIGHT         , MUIA_Pendisplay_Spec, (LONG) "rFFFFFFFF,24CE24CE,12D212D2" },
	{ GID_LOGNOTICE            , OID_SETTINGSCOLOR + PEN_LOGNOTICE            , MUIA_Pendisplay_Spec, (LONG) "rFFFFFFFF,8F098F09,1E1D1E1D" },
	{ GID_LOGINVITE            , OID_SETTINGSCOLOR + PEN_LOGINVITE            , MUIA_Pendisplay_Spec, (LONG) "rFFFFFFFF,96409640,34B234B2" },
	{ GID_LOGKICK              , OID_SETTINGSCOLOR + PEN_LOGKICK              , MUIA_Pendisplay_Spec, (LONG) "r61E061E0,FFFFFFFF,8CDC8CDC" },
	{ GID_LOGNICKCHANGE        , OID_SETTINGSCOLOR + PEN_LOGNICKCHANGE        , MUIA_Pendisplay_Spec, (LONG) "r43BE43BE,509F509F,FFFFFFFF" },
	{ GID_LOGTOPIC             , OID_SETTINGSCOLOR + PEN_LOGTOPIC             , MUIA_Pendisplay_Spec, (LONG) "rFFFFFFFF,07830783,0B570B57" },
	{ GID_LOGWALLOPS           , OID_SETTINGSCOLOR + PEN_LOGWALLOPS           , MUIA_Pendisplay_Spec, (LONG) "r527F527F,FFFFFFFF,2D292D29" },
	{ -1,0,0,0 },
};
