...
static STRPTR TAB_CYCLE_INWRITEMODE[ MSG_CY_CANCEL - MSG_CY_OVERWRITE + 2 ];
	...
	if( (obj = (Object *) DoSuperNew( cl, obj, MUIA_Group_Horiz, FALSE,
				...
				Child, MUICreateLabelLeft( MSG_MUICLASS_SETTINGSDCC_GENERAL_INFO ),
				Child, HGroup,
				...
				Child, HGroup,
					...
					Child, objs[ GID_CUSTOMADDRESS    ] = MUICreateStringFixed( MSG_MUICLASS_SETTINGSDCC_DCCADDRESS_GAD, DCCADDRESS_SIZEOF ),
				End,
				Child, HGroup,
				...
				End,
				Child, VSpace(5),
				Child, MUICreateLabelLeft( MSG_MUICLASS_SETTINGSDCC_INCOMING_INFO ),
				Child, HGroup,
				...
				End,
				Child, VSpace(5),
				Child, MUICreateLabelLeft( MSG_MUICLASS_SETTINGSDCC_OUTGOING_INFO ),
				Child, HGroup,
...
{
	appclasses[ CLASSID_SETTINGSDCC ] = MUI_CreateCustomClass( NULL, MUIC_Group, NULL, sizeof( struct mccdata ) ,  (APTR) ENTRY(MCC_SettingsDCC_Dispatcher) );
