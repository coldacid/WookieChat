...
static STRPTR TAB_CYCLE_NICKCOMPLETITION[ MSG_CY_AMIRC - MSG_CY_MIRC + 2 ];
	...
	if( (obj = (Object *) DoSuperNew( cl, obj, MUIA_Group_Horiz, FALSE,
				...
				Child, ColGroup(2),
					...
					Child, objs[ GID_EDITOR ] = MUICreatePopASL( MSG_MUICLASS_SETTINGSGENERAL_EDITOR_GAD, EDITOR_SIZEOF, MUII_PopFile, TAG_DONE ),
					Child, MUICreateLabel( MSG_MUICLASS_SETTINGSGENERAL_BROWSER_GAD ),
					Child, objs[ GID_BROWSER ] = MUICreatePopASL( MSG_MUICLASS_SETTINGSGENERAL_BROWSER_GAD, BROWSER_SIZEOF, MUII_PopFile, TAG_DONE ),
				End,
		TAG_DONE ) ) ) {
