...
static STRPTR TAB_CYCLE_NICKCOMPLETITION[ MSG_CY_WOOKIESTYLE - MSG_CY_MIRCSTYLE + 2 ];
	...
	if( (obj = (Object *) DoSuperNew( cl, obj,
				...
				Child, VGroup,
					...
					Child, ColGroup(2),
						...
						Child, objs[ GID_NICKCOMPLETITION ] = MUICreateCycle( MSG_MUICLASS_SETTINGSGENERAL_NICKCOMPLETITION_GAD, &TAB_CYCLE_NICKCOMPLETITION, MSG_CY_MIRCSTYLE, MSG_CY_WOOKIESTYLE ),
...
static IPTR MM_ReadConfig( struct IClass *cl, Object *obj, struct MP_SETTINGSGENERAL_READCONFIG *msg )
{
struct mccdata *mccdata = INST_DATA( cl, obj );
ULONG i;
